...
set :application, "Nyan"
set :node_file, "server.js"
set :host, "nyan.herpderp.fi"
set :repository, "git@github.com:PKJedi/nyan.git"
set :user, "nyan"
set :admin_runner, 'nyan'

set :scm, :git
set :deploy_via, :remote_cache
role :app, host
set(:deploy_to) { "/home/nyan/nyan-node/#{application}/#{node_env}" }
set :node_path, "/home/nyan/local/bin"
set :use_sudo, true
...
UPSTART
  ...
  task :npm_update, :roles => :app do
    run "cd #{release_path}; #{node_path}/npm install socket.io async"
  end
